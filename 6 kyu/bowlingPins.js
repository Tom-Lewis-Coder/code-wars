...
const bowlingPins = arr => {
  let startingArr = [7,8,9,10,null,4,5,6,null, ,2,3, ,null, , ,1, , , ,]
  let resArr = startingArr.map(x => arr.includes(x) ? x = ' ' : x === null ? x = '\n' : x = 'I')
  let str1 = resArr.join(' ').slice(0,7)
  let str2 = resArr.join(' ').slice(8)
